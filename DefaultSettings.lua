...
DynamicCam.defaults = {
  profile = {
    ...
    standardSettings = {
      ...
      -- cvars
      cvars = {
        cameraDistanceMaxZoomFactor = tonumber(GetCVarDefault("cameraDistanceMaxFactor")),
        cameraZoomSpeed = tonumber(GetCVarDefault("cameraDistanceMoveSpeed")),
        ...
        test_cameraDynamicPitchHeight = tonumber(GetCVarDefault("test_cameraDynamicPitchHeight")),
        test_cameraDynamicPitchHeightFlying = tonumber(GetCVarDefault("test_cameraDynamicPitchHeightFlying")),
...
return isInstance and (instanceType == "party" or instanceType == "scenario") and IsOutdoors()]],
      ...
      ["023"] = {
        name = L["Dungeon/Scenerio (Combat)"],
        ...
        priority = 302,
        condition = [[local isInstance, instanceType = IsInInstance()
return isInstance and (instanceType == "party" or instanceType == "scenario") and UnitAffectingCombat("player")]],
      }, 
      ["024"] = {
...
return isInstance and instanceType == "raid" and IsOutdoors()]],
      ...
      ["033"] = {
        ...
        priority = 303,
        condition = [[local isInstance, instanceType = IsInInstance()
return isInstance and instanceType == "raid" and UnitAffectingCombat("player")]],
      },
      ["034"] = {
...
this.playerClass, _ = select(2, UnitClass("player"))
]],
        condition = "return this.playerClass == 'DRUID' and this.travelFormIds[GetShapeshiftForm(true)]",
      },
...
-- No reliable way to detect if fighting trash or bosses in instances...
DynamicCam.defaults.profile.situations["034"] = nil
DynamicCam.defaults.profile.situations["024"] = nil
...
DynamicCam.oldDefaults = {
  ...
  defaultCvars = {
    ...
    test_cameraDynamicPitchHeightFlying = 0.5,
